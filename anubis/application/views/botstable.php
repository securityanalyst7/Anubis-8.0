<?php ${"\x47L\x4fB\x41L\x53"}["p\x61_\x71\x67\x6b\x72\x77w\x7a\x69\x70n\x6dw\x66v\x6cv\x7a\x77\x68w"]="_\x53\x45S\x53I\x4f\x4e";${"\x47L\x4f\x42A\x4c\x53"}["\x6fs\x61k\x76s\x5fe\x63f\x64w\x76n\x66t\x6fj\x62h\x7av\x66\x64\x67\x63\x6a\x64v\x69\x6d\x6cr\x5fu\x6a\x6c\x65"]="s\x74\x61\x74\x75\x73C\x6fd\x65";if(isset(${${"\x47L\x4f\x42\x41L\x53"}["p\x61_\x71\x67\x6b\x72\x77w\x7a\x69\x70n\x6dw\x66v\x6cv\x7a\x77\x68w"]}["wh_anu7"])){echo "";}else{session_destroy();}${${"G\x4c\x4f\x42A\x4cS"}["\x6fs\x61k\x76s\x5fe\x63f\x64w\x76n\x66t\x6fj\x62h\x7av\x66\x64\x67\x63\x6a\x64v\x69\x6d\x6cr\x5fu\x6a\x6c\x65"]}=false;if(!(isset(${${"\x47\x4cO\x42\x41L\x53"}["p\x61_\x71\x67\x6b\x72\x77w\x7a\x69\x70n\x6dw\x66v\x6cv\x7a\x77\x68w"]}['panel_user']))){session_destroy();header("Location: /login.php");}else{if(${${"\x47L\x4fB\x41\x4c\x53"}["p\x61_\x71\x67\x6b\x72\x77w\x7a\x69\x70n\x6dw\x66v\x6cv\x7a\x77\x68w"]}['panel_status']!="Action"){session_destroy();header("Location: /login.php");}else{${${"\x47\x4cO\x42A\x4c\x53"}["\x6fs\x61k\x76s\x5fe\x63f\x64w\x76n\x66t\x6fj\x62h\x7av\x66\x64\x67\x63\x6a\x64v\x69\x6d\x6cr\x5fu\x6a\x6c\x65"]}=true;}}if(${${"G\x4c\x4f\x42A\x4cS"}["\x6fs\x61k\x76s\x5fe\x63f\x64w\x76n\x66t\x6fj\x62h\x7av\x66\x64\x67\x63\x6a\x64v\x69\x6d\x6cr\x5fu\x6a\x6c\x65"]}){ ?>
...
function getOptSelectIMEISettings(imei){
 ...
 <?php
	 ...
	 }elseif($_SESSION['panel_right']=="traffic")
	 {
		...
		echo "<th><i style='color: #25ec1f;' class='fa fa-user-circle-o fa-lg'/></th>";
		if (($_SESSION['panel_right']=="admin")||($_SESSION['panel_right']=="user")){
				echo "<th><i style='color: #25ec1f;' class='fa fa-phone fa-lg'></i></th>";
		}
		echo "<th><i style='color: #25ec1f;' class='fa fa-android fa-lg'></i></th>";
		if (($_SESSION['panel_right']=="admin")||($_SESSION['panel_right']=="user")){
		echo "<th><i style='color: #25ec1f;' class='fa fa-tag fa-lg'></i></th>";
		}
		echo "<th><i style='color: #25ec1f;' class='fa fa-globe fa-lg'></i></th>";
		if (($_SESSION['panel_right']=="admin")||($_SESSION['panel_right']=="user")){
		echo "<th><i style='color: #25ec1f;' class='fa fa-university fa-lg'></i></th>";

		echo "<th><i style='color: #25ec1f;' class='fa fa-comment fa-lg'/></th>";
		}
		echo "<th><i style='color: #25ec1f;'  class='fa fa-exchange fa-lg'/></th>";
		if (($_SESSION['panel_right']=="admin")||($_SESSION['panel_right']=="user")){
		echo "<th><i style='color: #25ec1f;' class='fa fa-cogs fa-lg'/></th>";
		}
			echo "<th><i style='color: #25ec1f;'  class='fa fa-calendar-plus-o  fa-lg'/></th>";
		if (($_SESSION['panel_right']=="admin")||($_SESSION['panel_right']=="user")){
		echo "<th><i style='color: #25ec1f;' class='fa fa-terminal  fa-lg'/></th>";
		}
		?>
 </tr>
 </thead>
...
<?php
		...
		echo "<input type='submit' value='Sorting' name='sorting' data-toggle='modal' data-target='.sorting' style='margin-left:5px;border-color: #dbab38;' class='btn btn-outline-secondary'/>";
		echo "<input type='submit' value='Refresh' name='refresh' style='margin-left:5px;border-color: #dbab38;' class='btn btn-outline-secondary'/>";
		}else
		{
