...
<div class="menu2 header" style="background: #141517;">


	<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand"><img width = "140" src="images/icons/panel/oqJNeIC2.png"/></a>


      <ul class="navbar-nav mr-auto" style="background: #141517;">
...
<?php
  ...
  if ($_SESSION['panel_right']=="admin"){
	...
	if (($_SESSION['panel_right']=="admin")||($_SESSION['panel_right']=="user")){
				...
				<li class='nav-item' style='margin-right: 15px; margin-top: 28px'>
					<a class='nav-link' href='./build.php?cont=build'>
						<center>
